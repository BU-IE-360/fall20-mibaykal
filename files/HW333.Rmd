...
ggplot(mydata, aes(x=`Mortgaged House Sale Statistics`, y=..density..)) +
  geom_histogram(colour="blue", fill="lightskyblue", bins = 10)+ 
  geom_density(alpha=.2, colour="red", fill="orange") + labs(title = "Histograms of Number of Mortgaged House Sale in Turkey between 2015-2020", x = "       Number of Mortgaged House Sale", y = "Density") + theme_classic() + theme(axis.text.x = element_text(angle = 30, hjust = 1))
```
